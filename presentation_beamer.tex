...
\begin{frame}{Besoin des entreprises}
\end{frame}
...
\begin{frame}{Outils existant de mise en relation}
	contenu...
\end{frame}
\begin{frame}{Les méthodes de mise en relations existantes}
	contenu...
\end{frame}

\section{Justification de la méthode d'analyse utilisée et de conception de la plateforme numérique}
\begin{frame}{Analyse descriptive uni-variée}
	contenu...
\end{frame}
\begin{frame}{Analyse descriptive bis-variée}
	contenu...
\end{frame}
...
\begin{frame}{Analyse Factorielle Discriminante (AFD)}
	contenu...
\end{frame}
\begin{frame}{Modélisation dimensionnelle}
	contenu...
\end{frame}
% ============================================================
\section{Résultat}
% ============================================================
\begin{frame}{Résultat de l'analyse uni-variée}
	contenu...
\end{frame}
\begin{frame}{Résultat de l'analyse bis-variée}
	contenu...
\end{frame}
\begin{frame}{Résultat de l'ACM}
	contenu...
\end{frame}
\begin{frame}{Résultat de la CAH}
	contenu...
\end{frame}
\begin{frame}{Résultat de l'AFD}
	contenu...
\end{frame}
\begin{frame}{Résultat de la plateforme}
	contenu...
\end{frame}
