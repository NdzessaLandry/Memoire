...
\end{frame}
% ============================================================
\section{Analyse Multidimentionnelle }
% ============================================================
...
\begin{frame}{Profil Dominant des Trois Classes Obtenues}
	...
	\vfill
	\begin{center}
		\tiny \textit{Note : Les graphiques de répartition par variable (Figures \ref{fig:rep_class_anc} à \ref{fig:rep_classe_region}) sont disponibles en annexe.}
	\end{center}
\end{frame}
% -----------------------------------------------------------
