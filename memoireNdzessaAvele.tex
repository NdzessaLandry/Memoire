...
\newcommand{\titredoc}{Cartographie des besoins, conception et développement d'une plate-forme de mise en relation des entreprises}
%============================================================
%  DOCUMENT
%============================================================
\begin{document}
...
%	\frontmatter   % Si vous utilisez \mainmatter plus loin
	...
	\begin{itemize}
		\item M. ALAMINE OUSMANE MEY Ministre de l'Economie de la Planification et de l'Aménagement du Territoire pour nous avoir accordé la possibilité d'effectuer un stage académique au sein de la structure dont il a la charge;
