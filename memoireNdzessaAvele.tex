...
\newcommand{\titredoc}{Cartographie des besoins et conception, développement d'une plateforme de mise en relation des entreprises}
%============================================================
%  DOCUMENT
%============================================================
\begin{document}
...
%\printbibliography[title={Bibliographie}] % Génère la liste des références
	...
	\begin{figure}[H]
		...
		\caption{Communiqué d'inter\^et publique}
		\label{fig:admin}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{annexe6.jpg}
		\caption{Demande de communiqué à cameroun tribune}
		\label{fig:admin}
	\end{figure}
